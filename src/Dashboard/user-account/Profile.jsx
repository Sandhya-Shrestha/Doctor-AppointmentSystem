          ...
          <div className="mb-5">
            ...
            required
             ...
             <div className='mb-5 flex items-center gap-3'>
              {formData.photo && (<figure className='w-[50px] h-[50px] rounded-full border-2 boredr-solid border-primaryColor flex items-center justify-center'>
                <img src={formData.photo} alt="" className='w-[90px] h-[50px] rounded-full' />
              </figure>)}
