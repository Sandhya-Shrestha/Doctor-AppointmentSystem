        ...
        <div className='grid md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              <figure className='w-[300px] h-[400px] rounded-[50px]'>
              ...
              <div>
                ...
                <div className='flex items-center gap-[6px]'>
                  <span className='flex items-center gap-[6px] text-[16px] ledaing-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'>
                ...
                <p className='text_para text-[14px] leading-4 md:text-[15px] lg:max-w-[390px]'>
                With seven years of expertise, she practices as a doctor.
                </p>
              </div>
            </div>
